export const abi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_initialMaxSupply", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "newUnrevealedURI", type: "string" },
      { internalType: "bool", name: "newUseFancyMath", type: "bool" },
    ],
    name: "setParams",
    outputs: [],
    stateMutability: "nonpayable",
