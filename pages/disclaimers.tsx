...
export default function Dislaimers() {
  return (
    <Layout>
      <Text size={36} fw={700}>Disclaimers:</Text>
      <Text size="md">
      ...
      <Text size="md">
        ...
        to use them and are accountable for their use which must not go against
        the provisions set in the license
      </Text>
      <Text size="md">
        ...
        same use restrictions as the ones in the license and share a copy of the
        CreativeML OpenRAIL-M to all your users (please read the license
